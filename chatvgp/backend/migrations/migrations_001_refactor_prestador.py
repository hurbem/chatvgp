...
Executar: python migrations/migrations_001_refactor_prestador.py
"""
...
def run_migration():
    ...
    try:
        ...
        print("\n" + "="*60)
        print("⚠️ MIGRAÇÃO - AVISO")
        print("="*60)
        print(f"\nAviso: {str(e)}")
        print("\n💡 Isso pode significar:")
        print("  • Coluna já foi removida/adicionada (idempotente)")
        print("  • Ou há um erro real de conexão/tabela")
        print("\nContinuando mesmo assim (DROP/ADD com IF EXISTS)\n")
        return True  # Retorna True porque IF EXISTS torna idempotente
